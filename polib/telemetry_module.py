...
VERBOSE_LEVEL = VerboseLevel.WARNING
...
class Machine:
    ...
    @staticmethod
    def get_blender_addons() -> typing.Dict[str, typing.List[str]]:
        addon_utils_modules = {}
        for module in addon_utils.modules():
            try:
                ...
                addon_utils_modules[uuid.uuid4().hex] = \
                    f"Uncaught Exception while querying modules: {e}"
        ...
        for addon in bpy.context.preferences.addons:
            ...
            if loaded_state:
                ret["loaded"].append(addon.module)
            else:
                ret["missing"].append(addon.module)
